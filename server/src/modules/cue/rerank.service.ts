...
import { DEFAULT_MODEL, DEFAULT_MODEL_BASE_URL, MODEL_TIMEOUT_MS } from '../../common/constants'
    ...
    try {
      ...
      const response = await fetch(`${base}/v1/messages`, {
        ...
        body: JSON.stringify({
          ...
          system: SYSTEM,
          messages: [
            { role: 'user', content: this.describe(input.projection, pool, input.lastLevel) },
